      ...
      <ContainerCustom>
        <Paper>
          <Box padding={2} display={"flex"} flexDirection={"column"} gap={3}>
            ...
            <Typography variant="body2">
              На сторішки {'"'}оцінки{'"'} ви можете ознайомитись з переліком
              предметів, що будуть вивчатись протягом песного семестру. Також на
              цій сторінці будуть відображатись оцінки, отримані за песну
              дисципліну.
            </Typography>
            <Typography variant="body2">
